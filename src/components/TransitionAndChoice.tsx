...
interface TransitionAndChoiceProps {
  onComplete: (choice: "market" | "palace" | "bamboo") => void;
  playerName: string;
}

export function TransitionAndChoice({
  onComplete,
  playerName,
}: TransitionAndChoiceProps) {
  ...
  const narrations = [
    {
      text: "时空裂缝散发着如梦似幻的光芒。我能感受到从中传来的古老气息——那是青铜的锈蚀味，丝绸的幽香，还有墨汁未干的竹简香。我最后看了一眼熟悉的展厅... 还有桌上那杯还温热的菊花茶。",
    },
    {
    ...
    {
      text: "当我视线重新清晰时，我发现自己站在一个完全陌生的世界。天空散发着耀眼的白光，空气中飘浮着发光的粒子。脚下是由未知材质构成的大理石地面，上面刻着我看不懂但感觉似曾相识的古老符文。",
    },
    {
      text: "突然，我听到了熟悉的声音... 叮铃铃~ 是那个汉代铜铃！",
    },
    {
      text: "我循声望去，发现远处有一座气势恢宏的宫殿。铜绿色的屋顶在月光下闪闪发光，门前的石狮子眼中闪烁着红光。",
    },
    {
      text: "但同时，我也注意到左边有一片幽暗的竹林，林中隐约传来古筝的声音...",
    },
    {
      text: "还有右边那座看起来像是古代集市的地方，那里灯火通明，人声鼎沸。",
    },
  ];
