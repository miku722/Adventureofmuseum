...
export function PortalTransition({
  ...
  const narrations = [
    {
      text: "时空裂缝散发着如梦似幻的光芒。我能感受到从中传来的古老气息——那是青铜的锈蚀味，丝绸的幽香，还有墨汁未干的竹简香。我深吸一口气，消失在裂缝中。",
    },
    {
      text: "眩晕感袭来，世界在我眼前旋转、扭曲...当我视线重新清晰时，我发现自己站在一个完全陌生的世界。",
    },
    {
      text: "突然，我听到了熟悉的声音... 叮铃铃~ 我循声望去，发现远处有一座气势恢宏的宫殿。但同时，我也注意到左边有一片幽暗的竹林，林中隐约传来古筝的声音...还有右边那座看起来像是古代集市的地方，那里灯火通明，人声鼎沸。",
    },
  ];
