...
const buildNarrativeSegments = (playerName: string) => [
  {
    text: `${playerName}，这是你担任博物馆守夜人的第十年。工作很简单：默默地守护文化瑰宝，确保每一件文物都在它该在的位置上。`,
  },
  {
...
export function PrologueNarrator({
  ...
  const narrativeSegments = buildNarrativeSegments(playerName);
